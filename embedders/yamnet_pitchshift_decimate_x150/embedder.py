...
"""YAMNet, plus a real-audio x1.5-shifted copy of each frame, concatenated.
...
be over- or under-shot by a fixed octave. This is the x1.5 rung (a minor
...
used -- r=1.26 needs ~1.44 s, comfortably inside the 1.92 s available. Those
...
2048-d: unshifted YAMNet block + x1.5-shifted YAMNet block.
"""

RATIO = 1.5  # a perfect fifth
CONTEXT_FRAMES = 1  # one real frame of look-ahead covers any ratio <= 2


class EmbedderYamnetPitchshiftDecimateX150(_yamnet.EmbedderYamnet):
    embeddername = "yamnet_pitchshift_decimate_x150"
    context_frames = CONTEXT_FRAMES
    n_embeddings = _yamnet.EmbedderYamnet.n_embeddings * 2  # unshifted + real x1.5-shifted
